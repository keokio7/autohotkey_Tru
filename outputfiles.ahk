...
sendinput, ^l
sleep, 200
ControlGetText, foldernumber, Edit1, ahk_class CabinetWClass


StringToAdd := " DONE"
foldernumber := foldernumber . StringToAdd



;; create folder 1-%% done
;FileCreateDir, C:\Users\tony\Documents\STL PRE-LOADED\1-%foldernumber% done (20)
FileCreateDir, %foldernumber%
...
FileCopy, C:\Users\tony\Documents\OUTPUT FILES\%A_LoopReadline%.*, %foldernumber%
